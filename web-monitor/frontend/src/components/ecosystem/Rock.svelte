...
<div
    ...
    role="button"
    tabindex="0"
    aria-label="Géologie et minéraux"
>
    <!-- Tooltip -->
    <div
    ...
    <div class="relative" style="width: 80px; height: 60px;">
        ...
        <div class="absolute bottom-0 left-0 w-full h-12 bg-[#616161] border-2 border-[#424242]">
        ...
        <div class="absolute top-0 left-4 w-12 h-8 bg-[#757575] border-2 border-[#616161]">
        ...
        <div class="absolute bottom-0 -right-2 w-6 h-5 bg-[#616161] border border-[#424242]">
        ...
        <div class="absolute -top-2 left-2 w-16 h-6">
            <!-- Touffes de mousse -->
            <div class="absolute bottom-0 left-0 w-4 h-4 bg-[#2E7D32] border border-[#1B5E20]"></div>
            <div class="absolute bottom-0 left-3 w-5 h-5 bg-[#388E3C] border border-[#2E7D32]"></div>
            <div class="absolute bottom-0 left-6 w-4 h-4 bg-[#2E7D32] border border-[#1B5E20]"></div>
            <div class="absolute bottom-0 left-9 w-5 h-3 bg-[#4CAF50] border border-[#388E3C]"></div>
        ...
        <div class="absolute top-4 -left-1 w-3 h-8">
            <div class="absolute top-0 w-3 h-3 bg-[#2E7D32] border border-[#1B5E20]"></div>
            <div class="absolute top-2 w-2 h-4 bg-[#388E3C] border border-[#2E7D32]"></div>
        </div>

        <!-- Lichen clair -->
        <div class="absolute top-6 right-4 w-3 h-2 bg-[#AED581] opacity-80"></div>
        <div class="absolute bottom-4 left-6 w-2 h-2 bg-[#C5E1A5] opacity-60"></div>
    </div>

    <!-- Ombre portée -->
    <div class="absolute -bottom-1 left-1/2 -translate-x-1/2 w-20 h-3 bg-black/20 rounded-full blur-sm"></div>
</div>
